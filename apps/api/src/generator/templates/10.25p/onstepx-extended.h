...
#define DEBUG                         $onstepx_debug //    OFF, Use ON for background error messages only, use VERBOSE for all           Infreq
...
#define NV_WIPE                       $onstepx_nv_wipe //         OFF, Causes the defaults to be written back into NV (FLASH,EEPROM,etc.)  Infreq
