...
#define STA_DHCP_ENABLED             $eth_dhcp //       false, Wifi Station/Ethernet DHCP Enabled.                                 Adjust
#define STA_IP_ADDR        $eth_ip // ..168,1,55}, Wifi Station/Ethernet IP Address.                                   Adjust
#define STA_GW_ADDR         $eth_gw // ..,168,1,1}, Wifi Station/Ethernet GATEWAY Address.                              Adjust
#define STA_SN_MASK       $eth_mask // ..55,255,0}, Wifi Station/Ethernet SUBNET Mask.                                  Adjust
