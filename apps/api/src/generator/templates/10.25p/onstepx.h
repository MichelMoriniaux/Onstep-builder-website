...
#define CONFIG_NAME "JTW Trident $model (MANTICORE) $options"
...
#define AXIS1_ENCODER_COUNTS_PER_DEGREE $encoder_count
...
#define AXIS2_ENCODER_COUNTS_PER_DEGREE $encoder_count
